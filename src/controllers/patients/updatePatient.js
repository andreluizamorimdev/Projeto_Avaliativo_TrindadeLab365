...
async function updatePatient(request, response) {
    try {
        ...
        patientInDatabase.full_name = request.body.name || patientInDatabase.full_name;
        ...
        patientInDatabase.health_insurance_plan = request.body.health_insurance_plan || patientInDatabase.health;
